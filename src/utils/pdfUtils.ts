...
const FORM_FIELDS: FormFields = {
  ...
  signature: { x: 140, y: 579, maxWidth: 150 },
  ...
  spouseFatherName: { x: 480, y: 400, fontSize: 10 },
  spouseBirthDate: { x: 410, y: 375, fontSize: 10 },
  spouseGender: { x: 410, y: 375, fontSize: 10 },
  spouseBirthCountry: { x: 190, y: 350, fontSize: 10 },
  spouseImmigrationYear: { x: 100, y: 325, fontSize: 10 },
  spouseAddress: { x: 480, y: 300, fontSize: 10 },
  spouseCity: { x: 270, y: 300, fontSize: 10 },
  spouseZipCode: { x: 130, y: 275, fontSize: 10 },
  spouseMobile: { x: 470, y: 250, fontSize: 10 },
  spouseEmailUsername: { x: 280, y: 250, fontSize: 10 },
  spouseEmailDomain: { x: 430, y: 250, fontSize: 10 },
  spouseSignature: { x: 140, y: 200, maxWidth: 150 },
